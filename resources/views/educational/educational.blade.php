...
<div class="container-fluid py-4">
    ...
    <div>
        <a class="btn btn-primary col-2" href="{{ route('educationals.create') }}">Add Educational</a>
    </div>
          ...
          <table class="table align-items-center mb-0">
            <thead>
              <tr>
                ...
                <th class="text-uppercase text-white text-xxs font-weight-bolder opacity-7">SchoolName</th>
                <th class="text-uppercase text-white text-xxs font-weight-bolder opacity-7 ps-2">Year</th>
                <th class="text-center text-uppercase text-white text-xxs font-weight-bolder opacity-7">Address</th>
                  ...
                  <td>
                    ...
                    <form action="{{route('educationals.destroy', $educational->id)}}" method="POST">
                      ...
                      <div class="d-flex px-2 py-1">
                        ...
                        onclick="return confirm('Are You Want to Delete this Educational Attachment?')">Delete</button>
